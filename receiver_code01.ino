...
ISR(PCINT0_vect){
  ...
  // Making sure that all values received from the controller are mapped properlly with no out lying values that might cause damage.
  receiver_input_channel_1 = map(receiver_input_channel_1, 1000, 2000, 1000, 1800); // map(value, fromLow, fromHigh, toLow, toHigh)
  receiver_input_channel_2 = map(receiver_input_channel_2, 1000, 2000, 1000, 1800); // toHigh is the max outputed value....
  receiver_input_channel_3 = map(receiver_input_channel_3, 1000, 2000, 1000, 1800); // for the ESC's THIS SHOULD NEVER BE OVER 85% power or they burn out 
  receiver_input_channel_4 = map(receiver_input_channel_4, 1000, 2000, 1000, 1800); // hence why this is mapped too 1850
  // ===============================================================================================
